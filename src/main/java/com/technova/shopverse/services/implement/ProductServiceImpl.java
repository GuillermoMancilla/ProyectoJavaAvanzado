...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO toDTO(Product product){
        ...
        return new ProductDTO(product.getId(), product.getName(), product.getPrice(), product.getDescription(), categoryName);
    }
    ...
    public ProductDTO createProduct(ProductDTO productDto) {
        //COMENTADO PARA PROBAR LA VALIDACION INDICADA EN MODULO 8
